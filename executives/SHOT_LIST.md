...
|---|---|---|---|
| 1 | `assets/exec-m1-ask.png` | M1 | an executive question answered with chart and takeaways |
| 2 | `assets/exec-m3-briefing.png` | M3 | the daily exec digest or feed agent post |
